...
TEST_CASE("List::waterfall simple", "[weight=5][part=1][valgrind]") {
    List<int> list;
    for (int i = 1; i <= 8; i++)
        list.insertBack(i);
    list.waterfall();
...
TEST_CASE("List::waterfall images", "[weight=5][part=1]") {

    PNG in;        in.readFromFile("../data/alma.png");
    PNG expected;  expected.readFromFile("../data/expected-waterfall.png");
...
TEST_CASE("List::split edge", "[weight=5][part=1][valgrind]") {
    List<int> list;
...
TEST_CASE("List::split images", "[weight=5][part=1]") {
    ...
    PNG expected_1; expected_1.readFromFile("../data/expected-split_1.png");
    PNG expected_2; expected_2.readFromFile("../data/expected-split_2.png");
    PNG expected_3; expected_3.readFromFile("../data/expected-split_3.png");
