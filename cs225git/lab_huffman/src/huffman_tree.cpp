                            ...
                            queue<TreeNode*>& mergeQueue)
{
    ...
    if(singleQueue.empty()) {
        ans = mergeQueue.front();
        mergeQueue.pop();
    } else if(mergeQueue.empty()) {
        ans = singleQueue.front();
        singleQueue.pop();
...
void HuffmanTree::buildTree(const vector<Frequency>& frequencies)
{
    ...
    while(singleQueue.size() + mergeQueue.size() > 1) {
        ...
        TreeNode* merge = new TreeNode(first->freq.getFrequency() + second->freq.getFrequency());
        merge->left = first;
        merge->right = second;
    ...
    //     singleQueue.pop();
    //     TreeNode* second = singleQueue.front();
    //     singleQueue.pop();

    //     TreeNode* merge = new TreeNode(Frequency(first->freq.getFrequency() + second->freq.getFrequency()));
    //     merge->left = first;
    //     merge->right = second;
    ...
    //     TreeNode* first = mergeQueue.front();
    //     mergeQueue.pop();
    //     TreeNode* second = mergeQueue.front();
    //     mergeQueue.pop();
