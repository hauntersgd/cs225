  ...
  */
  ...
  public:
    ...
    */
    ...
    public:
      Iterator();
      Iterator(PNG png, Point start, double tolerance, TraversalFunctions fns, Point current);
      ...
      std::deque<Point> getDQ() const {
        return work_list_;
      }

      // std::vector<std::vector<bool>> getVisited() const {
      //   return visited;
      // }
    ...
    private:
      ...
      //std::unordered_map<Point, bool> visit;
